...
router.get('/:scheduleId', authenticationEnsurer, (req, res, next) => {
  ...
  // sequelize を利用しテーブルを結合してユーザーを取得する書き方
  // schedule.user というプロパティに、ユーザー情報が設定されます。
  // ユーザーの属性としては、ユーザー ID とユーザー名が取得
  Schedule.findOne({
    include: [
      {
        model: User,
    ...
    .then((availabilities) => {
      ...
      // ユーザー Map を作成し、まずは閲覧ユーザー自身を加えています
      // 閲覧ユーザーであるかどうかを示す isSelf というフラグ
      ...
      // 出欠のデータを 1 つでも持っていたユーザーをユーザー Map に含めています
      availabilities.forEach((a) => {
